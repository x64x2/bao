...
class UnifiedExchangePlugin(BasePlugin):
    ...
    to support CEX and DEX Exchange from priv repo
    More info: https://github.com/x64x2/cefi
    More info: https://github.com/x64x2/dxsp
    Order are identified and parsed
    using Findmyorder lib
    More info: https://github.com/x64x2/findmyorder
